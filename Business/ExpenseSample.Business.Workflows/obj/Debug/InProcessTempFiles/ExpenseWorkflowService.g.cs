...
namespace ExpenseSample.Business.Workflows {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class ExpenseWorkflowService : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ExpenseWorkflowService).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ExpenseWorkflowService));
        ...
        private string FindResource() {
            string[] resources = typeof(ExpenseWorkflowService).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ExpenseWorkflowService.g.xaml") || resource.Equals("ExpenseWorkflowService.g.xaml"))) {
                    return resource;
                }
            }
